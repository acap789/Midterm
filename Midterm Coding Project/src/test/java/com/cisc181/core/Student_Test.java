...
public class Student_Test {
	...
	Student.add(S1);Student.add(S2);Student.add(S3);Student.add(S4);Student.add(S5);Student.add(S6);Student.add(S7);Student.add(S8);Student.add(S9);Student.add(S10);
